...
# =================================================================  end Command-line arguments region  ================================================================= 
...
def main():
    ...
    print(" ENTERED SECTION 'LOAD DATASET' \n\n\n\n")
    ...
    print("DATASET HAS BEEN LOADED, ENTERED SECTION 'LOAD PRETRAINED MODEL AND TOKENIZER' \n\n\n\n")
    ...
    # =================================================================   end region Load pretrained model and tokenizer =================================================================  

    # =================================================================   region Dataset preprocessing =================================================================  
    
    print("ENTERED SECTION 'DATASET PREPROCESSING' \n\n\n\n")
    ...
    # =================================================================   end region Dataset preprocessing=================================================================  

    print("ENTERED SECTION 'PREPARE MODEL' \n\n\n\n")
    with training_args.strategy.scope():
        # =================================================================   region Prepare model =================================================================  
        if checkpoint is not None:
            #model = TFAutoModelForCausalLM.from_pretrained(checkpoint, config=config)
            model = TFAutoModelForSeq2SeqLM.from_pretrained(checkpoint, config=config)

        elif model_args.model_name_or_path:
            #model = TFAutoModelForCausalLM.from_pretrained(model_args.model_name_or_path, config=config)
            model = TFAutoModelForSeq2SeqLM.from_pretrained(model_args.model_name_or_path, config=config)
        ...
        # =================================================================  end region TF Dataset preparation =================================================================  

        # =================================================================  region Optimizer and loss =================================================================  
        
        print("ENTERED SECTION 'OPTIMIZER AND LOSS' \n\n\n\n")
        ...
        # =================================================================  end region Optimizer and loss =================================================================  

        # =================================================================  region Preparing push_to_hub and model card =================================================================  
        print("ENTERED SECTION 'PUSH TO HUB' \n\n\n\n")
        ...
        if training_args.push_to_hub:
            ...
            callbacks = []
        # =================================================================  end region Preparing push_to_hub and model card =================================================================  
        ...
        # =================================================================  end region Training and validation =================================================================  
